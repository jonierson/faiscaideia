...
tema_especifico = st.text_input("Informe o tema específico que você deseja explorar no seu projeto:" "(Ex.: 1. Impacto das redes sociais na saúde mental dos adolescentes; 2. Efeitos do aquecimento global na biodiversidade; 3. Desenvolvimento de materiais biodegradáveis; 4. O uso de tecnologias digitais no ensino; 5. Desenvolvimento de novas drogas a partir de plantas medicinais)",
                                key="tema_especifico")
...
conhecimento_previo = st.selectbox("Qual seu conhecimento prévio sobre esse tema?", ["","Nenhum", "Básico", "Intermediário", "Avançado"],
